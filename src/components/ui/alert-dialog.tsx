...
function AlertDialogTrigger({
  ...
  return (
    <AlertDialogPrimitive.Trigger
      ...
      render={<Button className={"w-29.5 cursor-pointer"} size={"lg"} />}
      {...props}
    />
  )
}
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        data-size={size}
        className={cn(
          "data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 bg-background ring-foreground/10 gap-3 rounded-xl p-4 ring-1 duration-100 max-w-[90vw] md:max-w-[70vw] group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2 -translate-y-1/2 outline-none",
          className
        )}
        {...props}
      />
